...
public class TractamentAlumnesNotes {
    ...
    /**
     * MÃ¨tode estÃ tic que crea el menu amb les opcions
     *
     * @throws SQLException
     * @throws IOException
     * @throws InputMismatchException ExcepciÃ³ corresponent a la introducciÃ³ d'una tecla
     */
    ...
    /**
     * MÃ¨tode que mostra tots els alumnes
     *
     * @throws SQLException
     */
    ...
    /*
     * Mostra tots els alumnes que compleixen la condiciÃ³
     */
    ...
    /**
     * Relitza una connexiÂ— a la BD, a partir de les propietats especificades en un fitxer database.properties
     *
     * @return la connexiÂ— amb la BD
     */
    public static Connection obtenirConnexio() throws SQLException, IOException {
        
        Properties propietats = new Properties();
        FileInputStream fitxerEntrada = new FileInputStream(System.getProperty("user.dir")+ "/src/Exercici2/database.properties");
