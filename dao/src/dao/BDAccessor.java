...
/**
 * Classe d'Utilitat per al manegament de la connexiÃ³ a la Base de dades. Sempre connecta a un SGBD MySQL i en
 * conseqÃ¼Ã¨ncia no fem servir la clau Driver del fixter de propietats
 *
 * @author sergi grau
...
public class BDAccessor {
    ...
    private void assignarPropietatsBD() throws IOException {
        ...
        try {
            propietats = carregarParametres("C:\\Users\\Erik\\Documents\\NetBeansProjects\\JavaEE-Servlet-JSP-Javabean\\dao\\src\\dao\\database.properties");
